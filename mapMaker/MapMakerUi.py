...
class Ui_MapMakerWindow(object):
    def setupUi(self, MapMakerWindow):
        ...
        self.horizontalLayout_4.addWidget(self.lineButton)
        self.arcButton = QtWidgets.QToolButton(self.centralwidget)
        self.arcButton.setObjectName("arcButton")
        self.horizontalLayout_4.addWidget(self.arcButton)
    ...
    def retranslateUi(self, MapMakerWindow):
        ...
        self.lineButton.setText(_translate("MapMakerWindow", "Line"))
        self.arcButton.setText(_translate("MapMakerWindow", "Arc"))
